...
from module_db import search_file, insert_db, update_db
...
def buttonSaveClick(vn, mfp, ins_update):
    c1 = 0 
    c2 = vn[0].get() + vn[1].get() + vn[2].get() + vn[3].get()
    c3 = 0 
    c4 = 0 
    c5 = 0 
    c6 = 0 
...
class PrgSieve(Frame):
    ...
    def initUI(self, myfilepath):
        ...
        value_R19C1 = IntVar()
        cb_R19C1 = Checkbutton(self, anchor='w', text='GENMOD', offvalue = 0, onvalue = 1, variable = value_R19C1)
        cb_R19C1.grid(row = 19, column = 1, sticky=W+E)
        # Checkbutton R19C2 = GLIMMIX
        value_R19C2 = IntVar()
        cb_R19C2 = Checkbutton(self, anchor='w', text='GLIMMIX', offvalue = 0, onvalue = 2, variable = value_R19C2)
        cb_R19C2.grid(row = 19, column = 2, sticky=W+E)
        # Checkbutton R19C3 = GLM
        value_R19C3 = IntVar()
        cb_R19C3 = Checkbutton(self, anchor='w', text='GLM', offvalue = 0, onvalue = 4, variable = value_R19C3)
        cb_R19C3.grid(row = 19, column = 3, sticky=W+E)
        # Checkbutton R19C4 = LIFEREG
        value_R19C4 = IntVar()
        cb_R19C4 = Checkbutton(self, anchor='w', text='LIFEREG', offvalue = 0, onvalue = 8, variable = value_R19C4)
        cb_R19C4.grid(row = 19, column = 4, sticky=W+E)
        # Checkbutton R19C5 = LOESS
        value_R19C5 = IntVar()
        cb_R19C5 = Checkbutton(self, anchor='w', text='LOESS', offvalue = 0, onvalue = 16, variable = value_R19C5)
        cb_R19C5.grid(row = 19, column = 5, sticky=W+E)
        # Checkbutton R19C6 = LOGISTIC
        value_R19C6 = IntVar()
        cb_R19C6 = Checkbutton(self, anchor='w', text='LOGISTIC', offvalue = 0, onvalue = 32, variable = value_R19C6)
        cb_R19C6.grid(row = 19, column = 6, sticky=W+E)
        # Checkbutton R19C7 = MIXED
        value_R19C7 = IntVar()
        cb_R19C7 = Checkbutton(self, anchor='w', text='MIXED', offvalue = 0, onvalue = 64, variable = value_R19C7)
        cb_R19C7.grid(row = 19, column = 7, sticky=W+E)
        # Checkbutton R19C8 = NLIN
        value_R19C8 = IntVar()
        cb_R19C8 = Checkbutton(self, anchor='w', text='NLIN', offvalue = 0, onvalue = 128, variable = value_R19C8)
        cb_R19C8.grid(row = 19, column = 8, sticky=W+E)
        # Checkbutton R19C9 = NLMIXED
        value_R19C9 = IntVar()
        cb_R19C9 = Checkbutton(self, anchor='w', text='NLMIXED', offvalue = 0, onvalue = 256, variable = value_R19C9)
        cb_R19C9.grid(row = 19, column = 9, sticky=W+E)
        # Checkbutton R19C10 = PHREG
        value_R19C10 = IntVar()
        cb_R19C10 = Checkbutton(self, anchor='w', text='PHREG', offvalue = 0, onvalue = 512, variable = value_R19C10)
        cb_R19C10.grid(row = 19, column = 10, sticky=W+E)
        # Checkbutton R19C11 = REG
        value_R19C11 = IntVar()
        cb_R19C11 = Checkbutton(self, anchor='w', text='REG', offvalue = 0, onvalue = 1024, variable = value_R19C11)
        cb_R19C11.grid(row = 19, column = 11, sticky=W+E)
        # Checkbutton R19C12 = SURVEYxxx
        value_R19C12 = IntVar()
        cb_R19C12 = Checkbutton(self, anchor='w', text='SURVEYxxx', offvalue = 0, onvalue = 2048, variable = value_R19C12)
        cb_R19C12.grid(row = 19, column = 12, sticky=W+E)
        ...
        value_R20C1 = IntVar()
        cb_R20C1 = Checkbutton(self, anchor='w', text='Program', offvalue = 0, onvalue = 1, variable = value_R20C1)
        cb_R20C1.grid(row = 20, column = 1, sticky=W+E)
        # Checkbutton R20C2 = Manual
        value_R20C2 = IntVar()
        cb_R20C2 = Checkbutton(self, anchor='w', text='Manual', offvalue = 0, onvalue = 2, variable = value_R20C2)
        cb_R20C2.grid(row = 20, column = 2, sticky=W+E)
        # Checkbutton R20C3 = Tutorial
        value_R20C3 = IntVar()
        cb_R20C3 = Checkbutton(self, anchor='w', text='Tutorial', offvalue = 0, onvalue = 4, variable = value_R20C3)
        cb_R20C3.grid(row = 20, column = 3, sticky=W+E)
        # Checkbutton R20C4 = Publication
        value_R20C4 = IntVar()
        cb_R20C4 = Checkbutton(self, anchor='w', text='Publication', offvalue = 0, onvalue = 8, variable = value_R20C4)
        cb_R20C4.grid(row = 20, column = 4, sticky=W+E)
        # Checkbutton R20C5 = Web document
        value_R20C5 = IntVar()
        cb_R20C5 = Checkbutton(self, anchor='w', text='Web document', offvalue = 0, onvalue = 16, variable = value_R20C5)
        cb_R20C5.grid(row = 20, column = 5, sticky=W+E)
